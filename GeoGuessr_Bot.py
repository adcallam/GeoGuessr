...
default_width=2558 #width of screen in pixels
default_height=1438 #height of screen in pixels
...
trim_x_2 = (2102/2558)*default_width #2102
trim_y_1 = (287/1438)*default_height #287
trim_y_2 = (1378/1438)*default_height #1378

iterations=5 #Number of times to takes pictures of ground-level
sky_iterations=5 #Number of times to takes pictures of sky
...
def find_window():
    ...
    #Grab the hwnd for first window matching google
    google = google[0]
    find_window.hwnd = google[0]

#Takes a screenshot and saves it to the "program_images_directory" variable directory with the name "screenshot_" followed by the "identifier" parameter value. 
...
def determine_hemisphere(lower_limit, upper_limit):
    ...
    while(n<sky_iterations):
        ...
        #If there are multiple screenshots with the sun, this will use the image with the largest sun
...
def decode_predictions(scores, geometry):
    ...
    for y in range(0, numRows):
        # Extract the scores (probabilities), followed by the geometrical data used to 
...
def determine_geocar(geocar_straight_is_reliable, x_compass_straight, y_compass_straight):
    ...
    if geocar_straight_is_reliable:
        ...
        while turn<3:
            ...
            min_white_car_contour_area = 10000 
            max_white_car_contour_area = 100000
            min_white_car_aspect_ratio = 3 
            ...
            min_black_car_contour_area = 10000 
            max_black_car_contour_area = 100000
            min_black_car_aspect_ratio = 3
